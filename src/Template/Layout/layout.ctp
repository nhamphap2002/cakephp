                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            <li><!-- start message -->
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <?= $this->Html->image('dist/img/user2-160x160.jpg', ['alt' => 'User Image', 'class'=>'img-circle']); ?>
                                                    </div>
                                                    <h4>
                                                        Support Team
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <?= $this->Html->image('dist/img/user3-128x128.jpg', ['alt' => 'User Image', 'class'=>'img-circle']); ?>
                                                    </div>
                                                    <h4>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <?= $this->Html->image('dist/img/user4-128x128.jpg', ['alt' => 'User Image', 'class'=>'img-circle']); ?>
                                                    </div>
                                                    <h4>
                                                        Developers
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                     <?= $this->Html->image('dist/img/user2-160x160.jpg', ['alt' => 'User Image', 'class'=>'user-image']); ?>
